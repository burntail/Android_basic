...
//                Log.d("youtubeyou",youtubeItemlist.toString())
                ...
                for (video in youtubeItemlist!!) {
                    Log.d("youtubeyou",video.title)
                }


            }
            override fun onFailure(call: Call<ArrayList<Youtube>>, t: Throwable) {
                Log.d("youtubeyou","fail!!!!")
            }
...
class YoutubeListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        glide.load(youtubeItemList.get(position).thumbnail).into(holder.thumbnail)
    }
